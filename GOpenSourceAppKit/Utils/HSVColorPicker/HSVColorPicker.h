...
@interface HSVColorPicker : UIControl<UIGestureRecognizerDelegate>
{
    // 大色环
...
@property (weak) id<HSVColorPickerDelegate>  delegate;
@end
...
@protocol RGBColorPickerDelegate;

#pragma mark - 类RGBColorPicker
@interface RGBColorPicker : HSVColorPicker
{
    CGFloat red;
    CGFloat green;
    CGFloat blue;
